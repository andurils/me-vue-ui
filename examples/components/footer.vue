  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a href="https://github.com/ElemeFE/element" class="footer-main-link" target="_blank">{{
          langConfig.repo
        }}</a>
        <a
        ...
        <a
          ...
          >{{ langConfig.theme }}</a
        >
        <a href="https://github.com/elemefe/element-react" class="footer-main-link" target="_blank"
          >Element-React</a
        >
        <a
      ...
      <div class="footer-main">
        ...
        >
        <a href="https://segmentfault.com/t/element-ui" class="footer-main-link" target="_blank"
          >SegmentFault</a
        >
        <a
